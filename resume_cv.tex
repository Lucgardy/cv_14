...
\name{Lucgardy}{Germain}
\address{2, LaFleur Ducheine, Port-au-Prince, Ha\"iti}
\mobile{(+509) 4380-9191}

\email{germainlucgardy@yahoo.fr}
%\homepage{www.posquit0.com}
%\github{posquit0}
\linkedin{Lucgardy Germain}
%\skype{skypeid}
...
\position{Statisticien {\enskip\cdotp\enskip}\'Economiste} % Your expertise/fields
\quote{``Once you have no problem making mistakes, admitting them, and correcting them, hardly any mistakes will happen."} % A quote or statement

\makecvfooter{\today}{Lucgardy Germain~~~·~~~ This resume was written in \LaTeX}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
